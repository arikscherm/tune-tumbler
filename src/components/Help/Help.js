  ...
  return (
    <div className="help-button-container">
      ...
      <Tooltip id="help-tooltip" place="top" effect="solid">
        ...
        <div className="gradient-arrow"/> Visit the <strong style={{color: "#34c453"}}>Tune Library</strong> page to customize the collection of tunes that sets are generated from.<br />
        <div className="gradient-arrow"/> On the <strong style={{color: "#34c453"}}>Remaining Tunes</strong> page, you'll find all of the tunes that haven't been used in any sets.<br />
        <div className="gradient-arrow"/> See the <strong style={{color: "#34c453"}}>Session Spinner</strong> to explore a map of every Irish session that has been submitted to thesession.org. (Link below) <br />
