  ...
  return (
    <div className="help-button-container">
      ...
      <Tooltip id="help-tooltip" place="top" effect="solid">
        ...
        <div className="gradient-arrow"/> See the <strong style={{color: "#34c453"}}>Session Spinner</strong> to explore a map of Irish sessions around the world (Data from <i><u>thesession.org</u></i> link below) <br />
